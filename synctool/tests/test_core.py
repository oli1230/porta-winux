...
from synctool.manifest import Manifest  # noqa: E402
from synctool.sync import _local_path, _sha256  # noqa: E402


def test_manifest_roundtrip(tmp_path):
    m = tmp_path / "synctool.toml"
    m.write_text(
...
def test_manifest_rejects_relative_paths(tmp_path):
    ...
    import pytest
    from synctool import SynctoolError
    with pytest.raises(SynctoolError):
        Manifest.load(m)
...
def test_fuzzy_filter():
    ...
    from synctool.browse import _fuzzy
