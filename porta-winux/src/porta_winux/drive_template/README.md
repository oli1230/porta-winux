...
`porta-winux init-drive /path/to/mounted/drive`.

- `porta-winux.toml`  — what to back up (profiles). Edit freely.
...
- `hooks.d/`       — drop executables here to extend porta-winux (see main README).
